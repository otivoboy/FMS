  ...
  return (
    <section id="home-services" className="py-20 bg-secondary">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:flex md:flex-wrap gap-4 md:gap-5 max-w-6xl mx-auto justify-center">
            {services.map((service) => (
              <Link key={service.title} href={service.href} className="group relative bg-card rounded-xl p-5 w-full md:w-[200px] text-center shadow-md transition-all duration-300 hover:-translate-y-1.5 hover:bg-yellow-50/50 hover:shadow-lg flex flex-col items-center min-h-[180px] no-underline overflow-hidden">
